...
from utils import pred_probs, stratify, true_sample_idx_each_class,compute_bc,find_all_neighbors_in_X

class NASSRandomSelectionStrategy(BatchSampleSelectionStratgy):
    ...
    def select(self) -> np.ndarray:
        CONF = self.CONF
        CONF.logger.info(f"NASS+Random Selecting samples. ")
        self.model.eval()
        ...
        #CONF.logger.info("Step 2.2. Compute LEBGP corrected probability")
