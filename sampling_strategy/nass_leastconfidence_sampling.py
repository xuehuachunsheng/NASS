...
class NASSLeastConfidenceStrategy(BatchSampleSelectionStratgy):
    ...
    def select(self) -> np.ndarray:
        CONF = self.CONF
        CONF.logger.info(f"NASS LeastConfidence Selecting samples. ")
        ...
        CONF.logger.info("Step 2.2. Compute Least Confidence")
